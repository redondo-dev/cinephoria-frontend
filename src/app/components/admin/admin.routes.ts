...
export const ADMIN_ROUTES: Routes = [
      {
        ...
        children: [
          ...
          {
            path: 'films',
            loadComponent: () => import('./pages/films/film-list/film-list.component')
              .then(m => m.FilmListComponent),
            title: 'Gestion des Films'
          },
          {
            path: 'films/create',
            loadComponent: () => import('./pages/films/film-form/film-form.component')
              .then(m => m.FilmFormComponent),
            title: 'Créer un Film'
          },
          {
            path: 'films/edit/:id',
          ...
          {
            path: 'employes',
            loadComponent: () => import('./pages/employes/employes-list/employes-list.component')
              .then(m => m.EmployesListComponent),
            title: 'Gestion des Employés'
          },
          {
            path: 'employes/create',
            loadComponent: () => import('./pages/employes/employe-form/employe-form.component')
